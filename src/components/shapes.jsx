...
function Shapes(cellSize) {
    return [
      ...
      { type: "LargeSquare", height: cellSize * 2, width: cellSize*2, x: 250, y: -50, borderRadius: 4, rotation: 0},
      { type: "QuarterCircle", height: cellSize, width: cellSize, x: 300, y: -50, borderRadius: "0 0% 100% 0%", rotation: 0},
      { type: "Arc", height: cellSize * 2, width: cellSize * 2, x: 350, y: -50, borderRadius: 4, strokeWidth: cellSize, rotation: 0},
